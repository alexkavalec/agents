...
today_profit,   today_vol   = scrape_window("today",   20)
...
print_table("TODAY — top 20 by unrealized PnL (open positions):", today_profit)
...
seen  = set()
combined = []
for lst in (alltime_profit, monthly_profit, weekly_profit, today_profit):
    for e in lst:
